...
public class ValidGuidAttribute : ValidationAttribute
{
    ...
    {
        // Null is valid to accommodate empty IDs on creation requests.
    ...
    {
        // Use the custom error message if provided, otherwise use the default message.
        return string.Format(ErrorMessage ?? "{0} must be a valid GUID.", name);
    }
}